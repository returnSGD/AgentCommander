...
export interface AgentSpaceState {
  ...
  workflowReviewComments: WorkflowReviewComment[];
...
export type WorkspaceEventType =
  ...
  | "workflow.issue_updated"
  | "workflow.proposal_submitted"
  | "workflow.proposal_updated"
  | "workflow.review_submitted"
  | "workflow.review_updated"
  | "workflow.proposal_merged"
  | "workflow.conflict_detected"
  | "workflow.conflict_resolved"
  | "workspace.reset";
...
export function createWorkspaceSnapshot(state: AgentSpaceState): WorkspaceSnapshot {
  return {
    ...
    workflowProposals: state.workflowProposals,
    workflowReviews: state.workflowReviews,
    workflowReviewComments: state.workflowReviewComments,
    workflowLocks: state.workflowLocks,
    workflowConflicts: state.workflowConflicts,
    workflowQueue: state.workflowQueue,
  };
}
