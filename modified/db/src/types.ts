...
export type WorkflowQueueEntryStatus = "queued" | "processing" | "completed" | "failed";
...
export interface WorkflowReviewCommentRecord {
  id: string;
  reviewId: string;
  reviewerId: string;
  content: string;
...
export interface WorkflowConflictRecord {
  id: string;
  workspaceId: string;
  resourceType: WorkflowLockResourceType;
  resourceId: string;
...
export interface WorkflowQueueEntryRecord {
  id: string;
  workspaceId: string;
  resourceType: WorkflowLockResourceType;
  resourceId: string;
  ...
  requestedBy: string;
  priority: number;
  status: WorkflowQueueEntryStatus;
  errorText?: string;
  queuedAt: string;
  startedAt?: string;
  completedAt?: string;
